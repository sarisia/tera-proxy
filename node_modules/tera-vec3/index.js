...
class Vec3 {
	...
	rotate(r) {
		let x = this.x
		this.x = x*Math.cos(r) - this.y*Math.sin(r)
		this.y = x*Math.sin(r) + this.y*Math.cos(r)
		return this
	}
	...
	rotateN(r) {
		return new Vec3(this.x*Math.cos(r) - this.y*Math.sin(r), this.x*Math.sin(r) + this.y*Math.cos(r), this.z)
	}
