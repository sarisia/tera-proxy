...
try
{
    TeraCrypto = require('tera-crypto-native');
}
catch(e)
{
    console.log('WARNING: Native (much faster) packet encryption is only supported on 64 bit Windows and Node 9.4.0 or higher!');
    console.log('WARNING: Falling back to slower JS-based packet encryption!');
    TeraCrypto = require('tera-crypto-js');
}
